...
import com.sephora.happyshop.ui.category.dummy.DummyContent.DummyItem;

import java.util.List;

/**
 * {@link RecyclerView.Adapter} that can display a {@link DummyItem} and makes a call to the
 * specified {@link OnCategoryFragmentListener}.
...
public class CategoryViewAdapter extends RecyclerView.Adapter<CategoryViewAdapter.ViewHolder> {
    ...
    public CategoryViewAdapter(List<DummyItem> items, OnCategoryFragmentListener listener) {
        mValues = items;
        mListener = listener;
    }
        ...
        holder.mView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (null != mListener) {
                    ...
                    mListener.onCategorySelected(holder.mItem);
                }
            }
        });
    }
